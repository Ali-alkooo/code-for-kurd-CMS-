...
?>
  ...
  <div class="accordion-item">
    ...
    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      <a style="color:white;" href="create_page.php?menu=<?php 
      echo mysqli_real_escape_string($conn,$row["id"]);?>"><h4> <?php
       echo mysqli_real_escape_string($conn,$row["item_name"]);?></h4></a>
      <?php
      $query1="SELECT * FROM `pages` WHERE `pages`.`item_name_id`=".mysqli_real_escape_string
      ($conn,$row["id"]);
      $result1=mysqli_query($conn,$query1);
      $row_cnt=mysqli_num_rows($result1);
                        ...
                        <ul>
                            <li> 
                            <?php 
    if ($row_cnt==0){echo "No pages";}
    elseif($row_cnt==1) {echo "page: ".$row_cnt;}
    else {echo "pages: ".$row_cnt;}
   ?> 
        </li>
    </ul>
...
<form method="post" action="creare_page_submit.php" enctype="multipart/form-data">

<div class="mb-3">
<label for="exampleInputEmail1" class="form-label" style="color:white;">ID Page Name  :</label>
  <select class="form-select" name="id_page_name">
      <option selected>Choose...</option>
<?php
$query="SELECT `id_page_name` FROM `pages` "; 
$result =mysqli_query($conn, $query); 
...
<div class=" mb-3">
<label for="exampleInputEmail1" class="form-label" style="color:white;">Image :</label>
<br>
