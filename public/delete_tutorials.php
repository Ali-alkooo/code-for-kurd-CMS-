    ...
    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      =".mysqli_real_escape_string($conn,$row["id"]);
                    ...
                    if (mysqli_num_rows($result1)>0){
                        ...
                        <ul>
                            <li> 
        <a style="color:white;"  href="delete_tutorials.php?tutorials=<?php 
...
?>
  ...
  while($row=mysqli_fetch_assoc($result)){
      ...
      echo"<tbody>";
      echo "<tr>";
      echo "<td><h5>".$row["name_content"]."</h5></td>";
      echo "<td><a class='btn btn-danger' href='delete_tutorials_submit.php?tutorials=".mysqli_real_escape_string($conn,$row["id"])."'>Delete</a></td>";
      echo "</tr>";
      echo "</tbody>";
      echo "</table>";
  }}
