...
?>
  ...
  <div class="accordion-item">
    ...
    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      <a style="color:white;" href="delete_menu.php?menu=<?php echo mysqli_real_escape_string($conn,$row["id"]);?>"><h4> <?php echo mysqli_real_escape_string($conn,$row["item_name"]);?></h4></a>
      <?php
      $query1="SELECT * FROM `pages` WHERE `pages`.`item_name_id`=".mysqli_real_escape_string($conn,$row["id"]);
                    ...
                    if (mysqli_num_rows($result1)>0){
                        ...
                        <ul>
                            <li> 
        <a style="color:white;"  href="delete_menu.php?page=<?php echo mysqli_real_escape_string($conn,$row1["id"]);?>"> <?php echo mysqli_real_escape_string($conn,$row1["page_name"]);?></a>
        </li>
    </ul>
<?php 
                        }
...
while($row=mysqli_fetch_assoc($result)){
      ...
      echo "<thed>";
      echo "<tr>";
      echo "<th><h3> Menu Name :</h3></th>";
      echo "<th><h3> Action</h3> </th>";
      echo "</tr>";
      echo "</thed>";
      echo"<tbody>";
      echo "<tr>";
      ...
      echo "<thed>";
      echo "<tr>";
      echo "<th><h3>Page Name :</h3> </th>";
      echo "<th> <h3> Action</h3> </th>";
      echo "</tr>";
      echo "</thed>";
      echo"<tbody>";
      echo "<tr>";
      echo "<td><h5>".$row1["page_name"]."</h5></td>";
      echo "<td><a class='btn btn-danger' 
      href='delete_page_submit.php?page="
      .mysqli_real_escape_string($conn,$row1["id"])."'>Delete</a></td>";
      echo "</tr>";
      echo "</tbody>";
      echo "</table>";
