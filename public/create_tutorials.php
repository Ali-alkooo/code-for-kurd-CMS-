    ...
    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      =".mysqli_real_escape_string($conn,$row["id"]);
                    ...
                    if (mysqli_num_rows($result1)>0){
                        ...
                        <ul>
                            <li> 
        <a style="color:white;"  href="create_tutorials.php?tutorials=<?php 
...
?>
    ...
    <i class="fa fa-plus-square" aria-hidden="true" style="color: white;"></i> 
     ...
     rgba(255, 255, 255, 0.00); box-shadow:0 5px 15px rgba(0,0,0,.25);">
            ...
            <form method="post" action="create_tutorials_submit.php"  enctype="multipart/form-data">
 
            <div class="mb-3">
<label for="exampleInputEmail1" class="form-label" style="color:white;">Page ID :</label>
  <select class="form-select" name="page_name_id">
...
?>
  ...
  <div class="mb-3">
    <label for="text" class="form-label" style="color:white;">Name Content :</label>
